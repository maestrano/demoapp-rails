# Hack environment parameters to point production config
# to Maestrano UAT environment
...
Maestrano::Configuration::EVT_CONFIG['production']['api.host'] = 'https://uat.maestrano.io'

# Hack environment parameters to point test config
# to Maestrano dev environment
# Maestrano::Configuration::EVT_CONFIG['test'].merge!(
...
# )
# Maestrano::Configuration::EVT_CONFIG['test']['api.host'] = 'http://localhost:3000'
...
Maestrano.configure do |config|
  ...
  config.api.key = (config.environment == 'production' ? 'c514be240975ffdb91aaeabe6e6ee98c167ee04dfa79724215d2380096214cbd' : 'aznoqb1ks0d84r9i2e63xmculvfg5t7hpwyj1')
